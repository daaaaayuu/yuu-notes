...
<u>4.使用@RequestBody時，要在該參數加上@Valid註解，才能讓這個calss裡的驗證請求參數生效<u>  
  例如:public String create(@RequestBody @Valid Student student)  
  
<u>5.使用@RequestParam、@RequestHeader、@PathVariable時，需要在Controller加上@Validated註解，才能夠讓驗證請求參數的註解生效<u>  
  例如:``@Validated  
       ``@RestController  
